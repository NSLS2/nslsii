...
AcqModeT = TypeVar("AcqModeT", bound=StrEnum)
...
class AcqModeFilenameProvider(UUIDFilenameProvider):
    ...
    def __init__(
        ...
        if not isinstance(mode_type, type) or not issubclass(mode_type, StrEnum):
            raise TypeError("Acquisition mode type must be a subclass of StrEnum!")
