...
class Thermo(PVGroup):
    ...
    readback = pvproperty(value=0, dtype=float, read_only=True, name="T-RB", mock_record="ai")
    ...
    async def readback(self, instance, async_lib):
        ...
        T = t_rbv(T0=self._T0, **{k: getattr(self, k).value for k in ["setpoint", "K", "omega", "Tvar"]})
...
if __name__ == "__main__":
    ioc_options, run_options = ioc_arg_parser(default_prefix="thermo:", desc=dedent(Thermo.__doc__))
